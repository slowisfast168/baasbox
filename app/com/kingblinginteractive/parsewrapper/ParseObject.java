...
public class ParseObject
{
	...
	protected Hashtable<String, Object> mData;
	...
	public void delete(boolean isUser) throws ParseException
	{
		String query = "";
		if(isUser)
		{
	...
	public void save(boolean isUser) throws ParseException
	{
		String query = "";
		if(isUser)
		{
	 ...
	 * do not have code to run on completion of the pushnotification.
	 */
